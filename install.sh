...
if [ ! -f /root/data/caddy/Caddyfile ]; then
    wget -q -O /root/data/caddy/Caddyfile https://raw.githubusercontent.com/WJQSERVER/caddy/main/conf/Caddyfile
fi
if [ ! -f /root/data/caddy/config/80 ]; then
    wget -q -O /root/data/caddy/config/80 https://raw.githubusercontent.com/WJQSERVER/caddy/main/conf/80
fi
